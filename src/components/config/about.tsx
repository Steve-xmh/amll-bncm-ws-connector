...
import { GroupBoxDevider } from "../appkit/group-box";
import { atom, useAtom, useAtomValue, useSetAtom } from "jotai";
import manifest from "virtual:bncm-plugin-manifest";
import "./about.sass";
import { enableUpdateBranchAtom, updateBranchAtom } from "./atoms";
import { FullSpinner, Spinner } from "../appkit/spinner/spinner";
import type { AlertProps } from "../appkit/alert";
	...
	return (
		<div className="amll-about">
			<div>
				...
				<div className="amll-name">AMLL WS Connector</div>
